			...
			<div class="contentcontainer">
				...
				<div class="contenttoolbar">
					...
					<div class="toolbar right">
						...
						<div class="button info" data-command="Info" title="About view inspector"></div>
						<div class="button close" data-command="Close" title="Close"></div>
					</div>
				</div>
			...
			<div class="toolscontainer">
				...
				<div class="viewtoolbar">
					<div class="toolbar left">
						...
						<div class="textbutton log" title="Show request log" data-command="ShowLog">
							<span>log</span>
						</div>
					</div>
					<div class="toolbar right">
