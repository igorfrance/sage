...
namespace Kelp.XInclude.XPointer
{
	...
	internal class LexUtils
	{
		...
		private const int FrameName = 2;
		private const int FrameStartName = 1;
		...
		static LexUtils()
		{
			...
			SetChars(NameStartChars, FrameStartName);
			SetChars(NameChars, FrameName);
		}
		...
		{
			return (chars[ch] & FrameStartName) != 0;
		}
