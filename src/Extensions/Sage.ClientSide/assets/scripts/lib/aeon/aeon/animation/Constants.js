...
/**
 * Defines the sequence types
 * @enum
 */
aeon.animation.SequenceType =
{
	/**
	 * Specifies a successive sequence type.
	 */
	SUCCESSIVE: "Successive",
	/**
	 * Specifies a simultaneous sequence type.
	 */
 ...
 */
aeon.animation.DEFAULT_RESOLUTION = 10;

/**
 * Default animation speed (in ms)
 */
aeon.animation.DEFAULT_DURATION = 500;

/**
 * Default easing equation.
 */
aeon.animation.DEFAULT_EASING = Math.easeOutCubic;

/**
 * Default sequence type.
 */
aeon.animation.DEFAULT_SEQUENCE_TYPE = aeon.animation.SequenceType.SUCCESSIVE;

aeon.animation.X11Colors =
{
...
/**
 * Global alias to the <c>aeon.animation</c> namespace.
 * @type {aeon.animation}
 */
var $anim = aeon.animation;
