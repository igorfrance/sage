	...
	<xsl:template match="/sage:view">
		<html>
			<head>
				...
				<script type="text/javascript" src="{sage:request/sage:path/@assetPath}/scripts/aeon.js"></script>
				<script type="text/javascript" src="{sage:request/sage:path/@assetPath}/scripts/tooltip.js"></script>
				<link rel="stylesheet" type="text/css" href="{sage:request/sage:path/@assetPath}/css/logview.css" />
			</head>
			<body>
				<div id="header">
